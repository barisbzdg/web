			...
			<?php 
			 if($x){
                ...
                foreach($k as $m){
					...
					<a href="/admin/?do=uye_duzenle&id=<?php echo $m["uye_id"];?>">duzenle</a></span> <span style="margin-left:10px;"><a href="/admin/?do=uye_sil&id=<?php echo $m["uye_id"];?>">sil</a></span></td>
					</tr>
					</tbody>
					<?php
