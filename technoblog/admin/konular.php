...
<div class="admin-icerik-sag"> 
			<h2>haberler <span style="float:right;"><a href="/admin/?do=konu_ekle">haber ekle</a></span></h2>
			<div class="konular"> 
			 ...
			 if($x){
                ...
                foreach($k as $m){
					...
					<td><span style="margin-left:35px;">
                        <a href="/admin/?do=konu_duzenle&id=<?php echo $m["konu_id"];?>">duzenle</a></span> <span style="margin-left:10px;"><a href="/admin/?do=konu_sil&id=<?php echo $m["konu_id"];?>">sil</a></span></td>
					</tr>
					</tbody>
					<?php
				...
				echo '<tr><td colspan="5"><div class="hata">henuz hiç haber 
